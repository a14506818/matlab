function [PSNRs1 PSNRs2]= Ann_dual_two_Difference_zone(   bpp_S, bpp_W, file_name, T_number, isDrawFigure, isColorImage, file_experiment, total_secret , message, secret_array,  reEncode_A, reEncode_B, showdetail, return_indicator, Block_array_size)
